      ...
      <div class="row c-sidebar__settings mt-3">
        ...
        <div class="c-collapsable-group">
          ...
          <div class="c-collapsable-group__container">
            ...
            <div class="col-12 mb-3">
              <Range name="iterations_per_class" tooltip="The number of labeled classifiers in your image set." label="Iterations Per Class" max="20000" min="1" value="2000" step="1" />
            </div>
